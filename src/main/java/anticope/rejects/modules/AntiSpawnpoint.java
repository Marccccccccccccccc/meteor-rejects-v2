...
public class AntiSpawnpoint extends Module {
    ...
    private void onSendPacket(PacketEvent.Send event) {
        ...
        boolean IsOverWorld = mc.world.getEnvironmentAttributes().getAttributeValue(EnvironmentAttributes.BED_RULE_GAMEPLAY, blockPos).canSetSpawn(mc.world);
        boolean IsNetherWorld = mc.world.getEnvironmentAttributes().getAttributeValue(EnvironmentAttributes.RESPAWN_ANCHOR_WORKS_GAMEPLAY, blockPos);
