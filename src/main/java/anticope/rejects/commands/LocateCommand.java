...
public class LocateCommand extends Command {
	...
	public void build(LiteralArgumentBuilder<CommandSource> builder) {
		builder.then(literal("feature")
				.then(argument("feature", EnumArgumentType.enumArgument(Cubiomes.StructureType.Village))
						.executes(ctx -> {
							Cubiomes.StructureType feature = EnumArgumentType.getEnum(ctx, "feature",
									Cubiomes.StructureType.Village);
							...
							if (version.isNewerOrEqualTo(MCVersion.v1_21)) {
								cubiomesVersion = Cubiomes.MCVersion.MC_1_21_WD;
